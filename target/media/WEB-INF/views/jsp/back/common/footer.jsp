...
<script src="${contextPath}/resources/editor/jquery.min.js"></script>
...
<script type="text/javascript" src="${contextPath}/resources/h-ui/lib/datatables/1.10.0/jquery.dataTables.min.js"></script> 
<!--/_footer /作为公共模版分离出去--> 